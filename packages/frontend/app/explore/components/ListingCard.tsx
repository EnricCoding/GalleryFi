    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const resolved = rawImage
                ? (rawImage.startsWith('ipfs://') ? ipfsToHttp(rawImage) : rawImage)
                : null;
        ...
        (async () => {
            try {
                ...
                const price = await getEthToUsdPrice();
                if (!cancelled) {
    ...
    return (
        ...
        >
            ...
            <div className="p-5 space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-neutral-500 dark:text-neutral-400">
                                {loadingPrice ? (
                                    <span className="inline-block w-16 h-4 bg-neutral-200 dark:bg-neutral-600 rounded animate-pulse"></span>
                                ) : ethPriceUsd ? (
                ...
                {/* Seller info with improved design */}
                <div className="flex items-center space-x-3 pt-2 border-t border-neutral-100 dark:border-neutral-700">
                    <div className="w-8 h-8 bg-gradient-to-br from-accent/20 to-accent-dark/20 
                ...
                <button
                    onClick={(e) => {
                        ...
                        console.log('Quick buy for NFT', tokenId);
                    }}
                ...
                >
                    ...
                    <div className="absolute inset-0 rounded-xl bg-accent/20 scale-0 group-hover/btn:scale-100 
                                  transition-transform duration-300 ease-out animate-pulse"></div>
                </button>
            </div>
        </Link>
    );
