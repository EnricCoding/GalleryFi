...
export class MyNFT__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class MyNFT extends ethereum.SmartContract {
  ...
  royaltyInfo(tokenId: BigInt, salePrice: BigInt): MyNFT__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new MyNFT__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    salePrice: BigInt,
  ): ethereum.CallResult<MyNFT__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new MyNFT__royaltyInfoResult(value[0].toAddress(), value[1].toBigInt()),
    );
  }
